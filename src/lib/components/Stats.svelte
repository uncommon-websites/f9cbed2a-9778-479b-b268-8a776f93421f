  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-16">
      <h2 class="text-3xl md:text-4xl font-semibold text-gray-900 mb-4">
        Proven results for<br>logistics operations.
      </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-gray-50 p-8 rounded-2xl">
        ...
        <div class="text-5xl font-semibold text-gray-900 mb-2">80%</div>
        <div class="text-sm text-gray-500">Time saved on manual email processing</div>
      </div>
      ...
      <div class="bg-gray-50 p-8 rounded-2xl">
        ...
        <div class="text-sm text-gray-500">Classification accuracy across all email types</div>
      </div>
    </div>
  </div>
</section>
